...
Install the cobra generator with the command `go install github.com/brozzis/cobra-cli@latest`. 
...
cobra-cli init can also be run from a subdirectory such as how the [cobra generator itself is organized](https://github.com/brozzis/cobra-cli).
